...
datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "saketde-on-youtubedb", table_name = "raw_statistics", transformation_ctx= "datasource0", push_down_predicate = predicate_pushdown)
...
datasink4 = glueContext.write_dynamic_frame.from_options(
    ...
    connection_type = "s3", connection_options = {"path": "s3://saketde-on-youtube-cleansed-useast1-dev/youtube/raw_statistics/", 
